  ...
  return (
    <div className="bg-gradient-to-tl from-zinc-900/0 via-zinc-900 to-zinc-900/0 w-screen h-full">
        ...
        <div className="flex flex-col items-center h-screen  mt-10 ">
            ...
            <br/>
            <p className="text-lg opacity-0 animate-fade-in-delayed text-zinc-300 text-center">I'm a software developer obsessed with building stuff</p>
            <br/>
            <p className="text-lg animate-fade-in-delayed-extra opacity-0 text-zinc-300 text-center">but that's not even half of it</p>
            <br/>
            <br/>
            <p className="text-md animate-fade-in-delayed-extra-extra opacity-0 text-zinc-300">the rest is coming soon!</p>
        </div>
    </div>
  )
}
